...
import static com.example.ulangansql.InputEditData.REQUEST_UPDATE;
...
public class MainActivity extends AppCompatActivity
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.fab_add){
            Intent intent = new Intent(MainActivity.this, InputEditData.class);
            startActivityForResult(intent, InputEditData.REQUEST_ADD);
        }
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == InputEditData.REQUEST_ADD){
            if (resultCode == InputEditData.RESULT_ADD){
                new LoadNoteAsync().execute();
            ...
            if (resultCode == InputEditData.RESULT_UPDATE) {
                new LoadNoteAsync().execute();
            ...
            else if (resultCode == InputEditData.RESULT_DELETE) {
                int position = data.getIntExtra(InputEditData.EXTRA_POSITION, 0);
