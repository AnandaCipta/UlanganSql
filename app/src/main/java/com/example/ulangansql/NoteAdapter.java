    ...
    public void onBindViewHolder(NoteViewholder holder, int position) {
        ...
        holder.cvNote.setOnClickListener(new CustomOnClickListener(position, new CustomOnClickListener.OnItemClickCallback() {
            ...
            public void onItemClicked(View view, int position) {
                Intent intent = new Intent(activity, InputEditData.class);
                intent.putExtra(InputEditData.EXTRA_POSITION, position);
                intent.putExtra(InputEditData.EXTRA_NOTE, getListNotes().get(position));
                activity.startActivityForResult(intent, InputEditData.REQUEST_UPDATE);
            }
        }));
    }
